...
# TODO (ptucker): Replace with mock framework. id:758
class FakeSummaryWriter(object):
  ...
  # NOTE: Ignore global_step since its value is non-deterministic. id:673
  ...
  # NOTE: Ignore global_step since its value is non-deterministic. id:735
