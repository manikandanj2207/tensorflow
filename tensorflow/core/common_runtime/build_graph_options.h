...
struct BuildGraphOptions {
  ...
  // TODO (vrv): Remove this when we unify target_nodes and fetch_endpoint, id:789
  ...
  // TODO (mrry): Remove this when the distributed runtime supports Arg/Retval. id:623
