...
class DeviceMgr {
 public:
  ...
  // TODO (zhifengc): Other initialization information. id:679
  // TODO (b/37437134): Use to track ownership. std::unique_ptr's id:741
 ...
 private:
  // TODO (b/37437134): Use to track ownership. std::unique_ptr's id:791
