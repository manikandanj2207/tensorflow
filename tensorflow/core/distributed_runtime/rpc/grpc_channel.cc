...
Status NewHostPortGrpcChannel(const string& target,
  ...
  // TODO (mrry): Implement secure channels. id:903
  ::grpc::ChannelArguments args;
  args.SetInt(GRPC_ARG_MAX_MESSAGE_LENGTH, std::numeric_limits<int32>::max());
  // NOTE (mrry): Some versions of gRPC use a 20-second minimum backoff id:1020
...
class CachingGrpcChannelCache : public GrpcChannelCache {
 ...
 private:
  // TODO (zhifengc): Eviction when the map becomes too big. id:852
  mutex mu_;
