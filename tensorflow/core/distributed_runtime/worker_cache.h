...
class WorkerCacheInterface {
 public:
  ...
  // TODO (mrry): rename this to GetOrCreateWorker() or something that id:1109
  ...
  //
  // TODO (jeff,sanjay): Consider moving target into WorkerInterface. id:911
  // TODO (jeff,sanjay): Unify all worker-cache impls and factor out a id:1028
