...
class WorkerFreeListCache : public WorkerCacheInterface {
 public:
  ...
  void ReleaseWorker(const string& target, WorkerInterface* worker) override {
    // TODO (jeff,sanjay): Should decrement ref-count when we implement eviction. id:1029
  }
 ...
 private:
  ...
  struct WorkerState {
    ...
    // TODO (jeff,sanjay): Add reference count if we support eviction. id:861
  };

  // TODO (jeff,sanjay): Eviction when the map becomes too big. id:955
  mutex mu_;
