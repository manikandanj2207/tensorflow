...
void PaddingFIFOQueue::TryDequeueMany(int num_elements, OpKernelContext* ctx,
  ...
  if (num_elements == 0) {
    ...
    for (int i = 0; i < num_components(); ++i) {
      // TODO (josh11b,misard): Switch to allocate_output(). id:1172
  ...
  bool already_cancelled;
  {
    ...
    if (!already_cancelled) {
      // TODO (josh11b): This makes two copies of callback, avoid this if possible. id:1410
            ...
            for (; queue_size > 0; --queue_size) {
              ...
              if (attempt->elements_requested == 0) {
                ...
                for (int i = 0; i < num_components(); ++i) {
                  ...
                  // TODO (ebrevdo): should this be a persistent tensor? id:1554
