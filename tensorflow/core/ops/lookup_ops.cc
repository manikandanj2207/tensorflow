...
REGISTER_OP("LookupTableInsert")
    ...
    .SetShapeFn([](InferenceContext* c) {
      ...
      // TODO (ebrevdo): Validate keys and values shape. id:1759
      return Status::OK();
    })
    .Doc(R"doc(
...
REGISTER_OP("LookupTableInsertV2")
    ...
    .SetShapeFn([](InferenceContext* c) {
      ...
      // TODO: Validate keys and values shape. id:1379
      return Status::OK();
    })
    .Doc(R"doc(
Updates the table to associates keys with values.
...
REGISTER_OP("LookupTableImport")
    ...
    .SetShapeFn([](InferenceContext* c) {
      ...
      // TODO (ebrevdo): Validate keys and values shape. id:1629
      return Status::OK();
    })
    .Doc(R"doc(
...
REGISTER_OP("LookupTableImportV2")
    ...
    .SetShapeFn([](InferenceContext* c) {
      ...
      // TODO: Validate keys and values shape. id:1690
      return Status::OK();
    })
    .Doc(R"doc(
Replaces the contents of the table with the specified keys and values.
