...
class LocalCLIDebugWrapperSession(framework.BaseDebugWrapperSession):
  ...
  def _prep_cli_for_run_end(self, debug_dump, tf_error, passed_filter):
    ...
    # TODO (cais): Reduce API surface area for aliases vis-a-vis tab id:1662
  ...
  def invoke_node_stepper(self,
    ...
    # TODO (cais): Perhaps some users will want the effect of the interactive id:2046
    ...
    # TODO (cais): Tie up register_tab_comp_context to a single alias to shorten id:1595
    # calls like this.
