...
// TODO: in windows ARRAYSIZE is defined in winnt.h but including it id:2383
...
//
// TODO (leary) switch to cuGetErrorName when updated cuda.h is available. id:2052
...
///////////////
// NOTE: here we specify return code values outside of the enum explicitly id:2303
...
// strings.
//
// NOTE: "Must reboot all context" below is shorthand for, "must id:2214
...
/* static */ port::Status CUDADriver::CreateContext(
  ...
  *context = nullptr;
  ...
  {
    // TODO (leary) Need to see if NVIDIA can expunge the leakiness in their id:2172
...
/* static */ bool CUDADriver::LoadPtx(CudaContext* context,
  ...
  GetDriverExecutor()->Schedule([context, ptx_contents, module, &ret,
    ...
    CUresult res;
    {
      // TODO (leary) Need to see if NVIDIA can expunge the leakiness in their id:2384
...
/* static */ bool CUDADriver::CreateStream(CudaContext *context,
                                           CUstream *out) {
  // TODO (leary) can we switch this to CU_STREAM_NON_BLOCKING or will that mess id:2053
