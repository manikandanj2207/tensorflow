...
export class ProjectionsPanel extends ProjectionsPanelPolymer {
  ...
  /** Polymer properties. */
  // TODO (nsthorat): Move these to a separate view controller. id:2317
  ...
  private setupUIControls() {
    ...
    // TODO: figure out why `--paper-input-container-input` css mixin didn't id:2228
    // work.
    const inputs =
  ...
  // TODO (nsthorat): Move this to its own class as the glue between this class id:2401
  // and the DOM.
