...
class ReferenceResolver(object):
  ...
  def reference_to_url(self, ref_full_name, relative_path_to_root):
    ...
    if master_name not in self._all_names:
      # TODO (josh11b): Make error reporting more uniform. id:2238
  ...
  def _cc_link(self, string, link_text, unused_manual_link_text,
    ...
    # TODO (josh11b): Fix this hard-coding of paths. id:2425
...
# TODO (aselle): Collect these into a big list for all modules and functions id:2111
...
def _parse_md_docstring(py_object, relative_path_to_root, reference_resolver):
  ...
  """
  # TODO (wicke): If this is a partial, use the .func docstring and add a note. id:2412
    ...
    for arg, default, ast_default in zip(
      ...
      if id(default) in reverse_index:
        ...
        if default_text != repr(default):
          ...
          # TODO (wicke): This should be replaced with a lookup in the index. id:2328
          # TODO (wicke): (replace first ident with tf., check if in index) id:2239
          internal_names = {
    ...
    for short_name in parser_config.tree[self.full_name]:
      ...
      if (defining_class is object or
          ...
          defining_class and defining_class.__name__ in ['CMessage', 'Message',
                                                         'MessageMeta']):
        continue
      # TODO (markdaoust): Add a note in child docs showing the defining class. id:2426
      ...
      if isinstance(child, property):
        ...
        # TODO (wicke): We may want to also remember the object itself. id:2112
...
def docs_for_object(full_name, py_object, parser_config):
  ...
  # TODO (wicke): Once other pieces are ready, enable this also for partials. id:2413
...
def _get_defined_in(py_object, parser_config):
  ...
  # TODO (wicke): If py_object is decorated, get the decorated object instead. id:2329
  # TODO (wicke): Only use decorators that support this in TF. id:2240
  ...
  # TODO (wicke): If this is a generated file, link to the source instead. id:2427
  # TODO (wicke): Move all generated files to a generated/ directory. id:2113
  # TODO (wicke): And make their source file predictable from the file name. id:2414
...
# TODO (markdaoust): This should just parse, pretty_docs should generate the md. id:2330
def generate_global_index(library_name, index, reference_resolver):
  ...
  # TODO (markdaoust): use a _ModulePageInfo -> prety_docs.build_md_page() id:2241
  return '\n'.join(lines)
