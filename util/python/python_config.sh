...
if [ -d "../org_tensorflow" ]; then
  ...
  # TODO (kchodorow): remove once runfiles paths are fixed, see id:2432
...
function setup_python {
  ...
  # TODO (ngiraldo): move most of these checks to root configure id:2118
  ...
  # TODO (ngiraldo): confirm if these checks are really necessary, remove if not id:2419
  ...
  # TODO (ngiraldo): move all below to root configure id:2370
